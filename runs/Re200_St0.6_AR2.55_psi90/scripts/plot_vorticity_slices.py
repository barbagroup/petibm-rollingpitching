...
annots = [Annotation('$V_1$', (-0.8, 0.4), (-0.77, 0.00)),
          Annotation('$V_2$', (1.0, -1.5), (0.71, -1.51)),
          Annotation('$V_3$', (-0.8, -1.0), (-0.41, -0.30)),
          Annotation('$V_4$', (1.1, 0.4), (1.19, -0.27))]
...
annots = [Annotation('inner', (-0.3, -1.5), (0.70, -1.06)),
          Annotation('outer', (2.0, -1.5), (1.77, -0.68))]
# Add annotations to figure.
for annot in annots:
    ax.annotate(annot.text, xy=annot.xyarrow, xycoords='data',
                xytext=annot.xytext,
