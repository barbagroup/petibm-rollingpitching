...
ring1 = get_midpoint(Point(238, 175), Point(326, 221))  # first vortex ring
ring2 = get_midpoint(Point(392, 103), Point(497, 167))  # second vortex ring
...
ring1 = get_midpoint(Point(273, 139), Point(273, 269))  # first vortex ring
ring2 = get_midpoint(Point(420, 119), Point(420, 266))  # second vortex ring
