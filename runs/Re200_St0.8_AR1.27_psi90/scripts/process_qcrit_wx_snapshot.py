...
ring1 = get_midpoint(Point(195, 184), Point(301, 215))  # first vortex ring
ring2 = get_midpoint(Point(322, 116), Point(434, 181))  # second vortex ring
...
annotate_angle(ax, r'$\alpha$', 524, line, hline, buf=100)

# Compute and plot inclination line for beta.
ring = (Point(268, 463), Point(374, 397))  # vortex ring extremities
beta = Line(*ring)
...
ax.plot(*hline.limits(), color='black', linestyle='-.', linewidth=3.0)
annotate_angle(ax, r'$\beta$', 250, line, hline)
