...
ring1 = get_midpoint(Point(181, 169), Point(277, 206))  # first vortex ring
ring2 = get_midpoint(Point(271, 86), Point(384, 203))  # second vortex ring
...
annotate_angle(ax, r'$\alpha$', 470, line, hline, buf=100)

# Compute and plot inclination line for beta.
ring = (Point(231, 475), Point(336, 427))  # vortex ring extremities
beta = Line(*ring)
...
ax.plot(*hline.limits(), color='black', linestyle='-.', linewidth=3.0)
annotate_angle(ax, r'$\beta$', 250, line, hline, buf=20)
