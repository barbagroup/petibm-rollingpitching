...
ring1 = get_midpoint(Point(215, 197), Point(316, 218))  # first vortex ring
ring2 = get_midpoint(Point(372, 131), Point(477, 181))  # second vortex ring
...
annotate_angle(ax, r'$\alpha$', 470, line, hline, buf=50)

# Compute and plot inclination line for beta.
ring = (Point(298, 457), Point(402, 399))  # vortex ring extremities
beta = Line(*ring)
print(f'beta: {beta.get_inclination():.2f}')
line = beta.extend(left=100, right=20)
ax.plot(*line.limits(), color='black', linestyle='--', linewidth=3.0)
hline = Line(line.p1, Point(line.p2.x, line.p1.y))
ax.plot(*hline.limits(), color='black', linestyle='-.', linewidth=3.0)
annotate_angle(ax, r'$\beta$', 300, line, hline)
...
ring1 = get_midpoint(Point(276, 152), Point(267, 283))  # first vortex ring
ring2 = get_midpoint(Point(426, 142), Point(413, 288))  # second vortex ring
