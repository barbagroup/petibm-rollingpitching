...
alpha = (Point(177, 240), Point(583, 109))  # in pixels
line = Line(*alpha)
print(f'alpha: {line.get_inclination():.2f}')
ax.plot(*line.create_line_guide(*alpha, extend_left=50, extend_right=250),
        color='black', linestyle='--', linewidth=2.0)
beta = (Point(294, 451), Point(405, 405))  # in pixels
line = Line(*beta)
print(f'beta: {line.get_inclination():.2f}')
ax.plot(*line.create_line_guide(*beta, extend_left=20, extend_right=20),
        color='black', linestyle='--', linewidth=2.0)
...
gamma = (Point(173, 174), Point(631, 174))  # in pixels
line = Line(*gamma)
