...
annots = [Annotation('$V_1$', (-0.8, 0.4), (-0.58, -0.07)),
          Annotation('$V_2$', (0.6, -1.5), (0.37, -0.93)),
          Annotation('$V_3$', (-0.8, -1.5), (-0.35, -0.32)),
          Annotation('$V_4$', (0.6, 0.4), (0.48, -0.27))]
...
# Set configuration of annotations to add.
annots = [Annotation('inner', (-0.3, -1.5), (0.57, -0.80)),
          Annotation('outer', (1.0, -1.5), (1.24, -0.63))]
# Add annotations to figure.
for annot in annots:
    ax.annotate(annot.text, xy=annot.xyarrow, xycoords='data',
                xytext=annot.xytext,
