...
The simulation computed 10000 time steps in about 23.7 hours on 6 `small-gpu` nodes (20 MPI processes and 2 GPU devices per node) in a Singularity container.
...
```ascii
Cycle-averaged thrust: 0.38620604563028216
Cycle-averaged thrust coefficient: 0.9859742657785675
Cycle-averaged hydrodynamic power: 2.2359258189775204
Propulsive efficiency: 0.17272757546441883
```
