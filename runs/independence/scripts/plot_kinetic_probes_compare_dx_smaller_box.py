...
def get_kinetic_energy_profiles(datadir, config, xlocs):
    ...
    # Get time values recorded.
    filepath = datadir / 'probe2-u-kin.h5'
    with h5py.File(filepath, 'r') as f:
        times = list(float(t) for t in f['u'].keys())
...
if args.save_figures:
    ...
    figname_suffix = '_compare_dx_smaller_box'
...
xlocs = [2.0, 3.0, 4.0, 5.0]  # locations along the x-direction
