"""Plot the instantaneous force coefficients for different exit criteria."""
...
# Load force coefficients for simulation with exit criterion 10^-6.
label = 'atol $= 10^{-6}$'
...
# Load force coefficients for simulation with exit criterion 10^-9.
label2 = 'atol $= 10^{-9}$'
simudir2 = maindir / 'run4'
