"""Plot instantaneous force coefficients for different time-step sizes."""
...
# Load force coefficients for simulation with 1000 time steps per cycle.
label = '$n = 1000$'
simudir = maindir / 'run2'
...
# Load force coefficients for simulation with 2000 time steps per cycle.
label2 = '$n = 2000$'
simudir2 = maindir / 'run5'
config2 = rodney.WingKinematics(nt_period=2000)
