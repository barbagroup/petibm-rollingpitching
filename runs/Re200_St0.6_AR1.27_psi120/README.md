# Re=200, St=0.6, AR=1.27, psi=120

Simulation of the three-dimensional flow around a pitching and rolling circular flat plate (AR=1.27) at Reynolds number Re=200, Strouhal number St=0.6, with a phase-difference angle of 120 degrees (between the rolling and pitching motions).
...
```ascii
Cycle-averaged thrust: 0.5837727691291446
Cycle-averaged thrust coefficient: 1.4903571136083176
Cycle-averaged hydrodynamic power: 3.6411936680450645
Propulsive efficiency: 0.16032455901818832
```
