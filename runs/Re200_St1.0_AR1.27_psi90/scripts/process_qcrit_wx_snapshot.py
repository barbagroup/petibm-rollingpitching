...
ring1 = get_midpoint(Point(187, 172), Point(287, 211))  # first vortex ring
ring2 = get_midpoint(Point(284, 97), Point(415, 175))  # second vortex ring
...
annotate_angle(ax, r'$\alpha$', 470, line, hline, buf=75)

# Compute and plot inclination line for beta.
ring = (Point(243, 466), Point(354, 411))  # vortex ring extremities
beta = Line(*ring)
...
ax.plot(*hline.limits(), color='black', linestyle='-.', linewidth=3.0)
annotate_angle(ax, r'$\beta$', 260, line, hline, buf=30)
